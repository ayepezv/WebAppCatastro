   ...
   width: 1.25
            ...
            layer: 'lyr_predios'
                        ...
                        var style = [ new ol.style.Style({
                             stroke: new ol.style.Stroke({color: "rgba(0,0,2,1.0)", lineDash: null, width: pixelsFromMm(0.6)}),
...
zIndex: 0
            ...
            layer: 'lyr_piso_edificacion1'
                        ...
                        var value = "";
                        var style = [ new ol.style.Style({
                             stroke: new ol.style.Stroke({color: "rgba(58,20,4,1.0)", lineDash: null, width: pixelsFromMm(1.0)}),
                        fill: new ol.style.Fill({color: "rgba(238,92,45,1.0)"}),
zIndex: 0
                        })
                        ];
                        var allStyles = [];
...
zIndex: 0
                    ...
                    var textStyleCache_piso_edificacion2={}
                    var clusterStyleCache_piso_edificacion2={}
                    var style_piso_edificacion2 = function(feature, resolution){
                        var context = {
            feature: feature,
            variables: {},
            layer: 'lyr_piso_edificacion2'
        };
                        
                        var value = "";
                        var style = [ new ol.style.Style({
                             stroke: new ol.style.Stroke({color: "rgba(4,6,58,1.0)", lineDash: null, width: pixelsFromMm(1.0)}),
                        fill: new ol.style.Fill({color: "rgba(18,60,232,1.0)"}),
zIndex: 0
                        })
                        ];
                        var allStyles = [];
                    ...
                    var selectionStyle_piso_edificacion2 = function(feature, resolution){
                        var context = {
            feature: feature,
            variables: {},
            layer: 'lyr_piso_edificacion2'
...
zIndex: 0
                    ...
                    var textStyleCache_piso_edificacion3={}
                    var clusterStyleCache_piso_edificacion3={}
                    var style_piso_edificacion3 = function(feature, resolution){
                        var context = {
            feature: feature,
            variables: {},
            layer: 'lyr_piso_edificacion3'
        };
                        
                        var value = "";
                        var style = [ new ol.style.Style({
                             stroke: new ol.style.Stroke({color: "rgba(38,4,40,1.0)", lineDash: null, width: pixelsFromMm(1.0)}),
                        fill: new ol.style.Fill({color: "rgba(168,2,185,1.0)"}),
zIndex: 0
                        })
                        ];
                        var allStyles = [];
                    ...
                    var selectionStyle_piso_edificacion3 = function(feature, resolution){
                        var context = {
            feature: feature,
            variables: {},
            layer: 'lyr_piso_edificacion3'
...
zIndex: 0
                    ...
                    var textStyleCache_piso_edificacion4={}
                    var clusterStyleCache_piso_edificacion4={}
                    var style_piso_edificacion4 = function(feature, resolution){
                        var context = {
            feature: feature,
            variables: {},
            layer: 'lyr_piso_edificacion4'
        };
                        
                        var value = "";
                        var style = [ new ol.style.Style({
                             stroke: new ol.style.Stroke({color: "rgba(0,0,0,1.0)", lineDash: null, width: pixelsFromMm(0.26)}),
                        fill: new ol.style.Fill({color: "rgba(169,245,198,1.0)"}),
zIndex: 0
                        })
                        ];
                        var allStyles = [];
                    ...
                    var selectionStyle_piso_edificacion4 = function(feature, resolution){
                        var context = {
            feature: feature,
            variables: {},
            layer: 'lyr_piso_edificacion4'
...
var wfsSource_piso_edificacion1 = new ol.source.Vector({
                        ...
                        strategy: ol.loadingstrategy.tile(new ol.tilegrid.createXYZ({maxZoom: 19}))
                            ...
                            id: "piso_edificacion120170614235136334",
                            wfsInfo: {featureNS: '',
...
var wfsSource_piso_edificacion2 = new ol.source.Vector({
                        format: new ol.format.GeoJSON(),
                        loader: function(extent, resolution, projection) {
                          var url = 'http://catastro.archidona.gob.ec:8084/geoserver/wfs?service=WFS&version=1.1.0&request=GetFeature' +
                                '&typename=Archidona:piso_edificacion2&outputFormat=application/json&' +
                                '&srsname=EPSG:32718&bbox=' + extent.join(',') + ',EPSG:32718';
                          var xmlhttp = new XMLHttpRequest();
                          xmlhttp.onreadystatechange = function() {
                            if (xmlhttp.readyState === 4 && xmlhttp.status === 200) {
                              var features = wfsSource_piso_edificacion2.getFormat().readFeatures(xmlhttp.responseText, {featureProjection: projection, dataProjection: "EPSG:32718"});
                              wfsSource_piso_edificacion2.addFeatures(features);
                            }
                          };
                          xmlhttp.open('GET', url, true);
                          xmlhttp.send();
                        ...
                        strategy: ol.loadingstrategy.tile(new ol.tilegrid.createXYZ({maxZoom: 19}))
                    });var lyr_piso_edificacion2 = new ol.layer.Vector({
                            opacity: 1.0,
                            source: wfsSource_piso_edificacion2,  
                            style: style_piso_edificacion2,
                            selectedStyle: selectionStyle_piso_edificacion2,
                            title: "piso_edificacion2",
                            id: "piso_edificacion220170614235137362",
                            wfsInfo: {featureNS: '',
                    featureType: 'piso_edificacion2',
                    geometryType: 'MultiPolygon',
                    geometryName: 'the_geom',
                    featurePrefix: 'Archidona',
                    url: 'http://catastro.archidona.gob.ec:8084/geoserver/wfs'
...
var lyr_piso_edificacion2_overview = new ol.layer.Vector({
                                opacity: 1.0,
                                source: wfsSource_piso_edificacion2,  
                                style: style_piso_edificacion2,
                                title: "piso_edificacion2",
...
var wfsSource_piso_edificacion3 = new ol.source.Vector({
                        format: new ol.format.GeoJSON(),
                        loader: function(extent, resolution, projection) {
                          var url = 'http://catastro.archidona.gob.ec:8084/geoserver/wfs?service=WFS&version=1.1.0&request=GetFeature' +
                                '&typename=Archidona:piso_edificacion3&outputFormat=application/json&' +
                                '&srsname=EPSG:32718&bbox=' + extent.join(',') + ',EPSG:32718';
                          var xmlhttp = new XMLHttpRequest();
                          xmlhttp.onreadystatechange = function() {
                            if (xmlhttp.readyState === 4 && xmlhttp.status === 200) {
                              var features = wfsSource_piso_edificacion3.getFormat().readFeatures(xmlhttp.responseText, {featureProjection: projection, dataProjection: "EPSG:32718"});
                              wfsSource_piso_edificacion3.addFeatures(features);
                            }
                          };
                          xmlhttp.open('GET', url, true);
                          xmlhttp.send();
                        ...
                        strategy: ol.loadingstrategy.tile(new ol.tilegrid.createXYZ({maxZoom: 19}))
                    });var lyr_piso_edificacion3 = new ol.layer.Vector({
                            opacity: 1.0,
                            source: wfsSource_piso_edificacion3,  
                            style: style_piso_edificacion3,
                            selectedStyle: selectionStyle_piso_edificacion3,
                            title: "piso_edificacion3",
                            id: "piso_edificacion320170614235137716",
                            wfsInfo: {featureNS: '',
                    featureType: 'piso_edificacion3',
                    geometryType: 'MultiPolygon',
                    geometryName: 'the_geom',
                    featurePrefix: 'Archidona',
                    url: 'http://catastro.archidona.gob.ec:8084/geoserver/wfs'
...
var lyr_piso_edificacion3_overview = new ol.layer.Vector({
                                opacity: 1.0,
                                source: wfsSource_piso_edificacion3,  
                                style: style_piso_edificacion3,
                                title: "piso_edificacion3",
...
var wfsSource_piso_edificacion4 = new ol.source.Vector({
                        format: new ol.format.GeoJSON(),
                        loader: function(extent, resolution, projection) {
                          var url = 'http://catastro.archidona.gob.ec:8084/geoserver/wfs?service=WFS&version=1.1.0&request=GetFeature' +
                                '&typename=Archidona:piso_edificacion4&outputFormat=application/json&' +
                                '&srsname=EPSG:32718&bbox=' + extent.join(',') + ',EPSG:32718';
                          var xmlhttp = new XMLHttpRequest();
                          xmlhttp.onreadystatechange = function() {
                            if (xmlhttp.readyState === 4 && xmlhttp.status === 200) {
                              var features = wfsSource_piso_edificacion4.getFormat().readFeatures(xmlhttp.responseText, {featureProjection: projection, dataProjection: "EPSG:32718"});
                              wfsSource_piso_edificacion4.addFeatures(features);
                            }
                          };
                          xmlhttp.open('GET', url, true);
                          xmlhttp.send();
                        ...
                        strategy: ol.loadingstrategy.tile(new ol.tilegrid.createXYZ({maxZoom: 19}))
                    });var lyr_piso_edificacion4 = new ol.layer.Vector({
                            opacity: 1.0,
                            source: wfsSource_piso_edificacion4,  
                            style: style_piso_edificacion4,
                            selectedStyle: selectionStyle_piso_edificacion4,
                            title: "piso_edificacion4",
                            id: "piso_edificacion420170614235137967",
                            wfsInfo: {featureNS: '',
                    featureType: 'piso_edificacion4',
                    geometryType: 'MultiPolygon',
                    geometryName: 'the_geom',
                    featurePrefix: 'Archidona',
                    url: 'http://catastro.archidona.gob.ec:8084/geoserver/wfs'
...
var lyr_piso_edificacion4_overview = new ol.layer.Vector({
                                opacity: 1.0,
                                source: wfsSource_piso_edificacion4,  
                                style: style_piso_edificacion4,
                                title: "piso_edificacion4",
...
lyr_piso_edificacion2.setVisible(true);
lyr_piso_edificacion3.setVisible(true);
lyr_piso_edificacion4.setVisible(true);
for (var i=0;i<baseLayers.length;i++){baseLayers[i].setVisible(false);}
baseLayers[0].setVisible(true);
var layersList = [lyr_predios,lyr_piso_edificacion1,lyr_piso_edificacion2,lyr_piso_edificacion3,lyr_piso_edificacion4];layersList.unshift(baseLayersGroup);
var layersMap  = {'lyr_predios':lyr_predios,'lyr_piso_edificacion1':lyr_piso_edificacion1,'lyr_piso_edificacion2':lyr_piso_edificacion2,'lyr_piso_edificacion3':lyr_piso_edificacion3,'lyr_piso_edificacion4':lyr_piso_edificacion4};
var view = new ol.View({ maxZoom: 32, minZoom: 1, projection: 'EPSG:32718'});
var originalExtent = [183796.965723, 9895681.374756, 195491.575101, 9906504.149502];
...
class BasicApp extends React.Component {
  ...
  render() {
    var toolbarOptions = {title:"Grupo"};
