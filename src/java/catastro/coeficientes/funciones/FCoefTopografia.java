...
public class FCoefTopografia {

    public static List<CoefTopografia> obtenerCoeficientes() throws Exception {
        List<CoefTopografia> lst = new ArrayList<>();
        AccesoDatos accesoDatos;
        CoefTopografia coeficiente;
        ResultSet resultSet;
        String sql;
        try {
            accesoDatos = new AccesoDatos();
            sql = "SELECT * from catastro.f_coefiencientes_topografia();";
            resultSet = accesoDatos.ejecutaQuery(sql);
            while (resultSet.next()) {
                coeficiente = new CoefTopografia();
    ...
    public static String registrarCoeficiente(CoefTopografia coeficiente) throws Exception {
        String respuesta;
        AccesoDatos accesoDatos;
        String sql;
        ...
        try {
            accesoDatos = new AccesoDatos();
            sql = "select * from catastro.f_insertar_coef_topografia(?,?,?,?)";
    ...
    public static String actualizarCoeficiente(CoefTopografia coeficiente) throws Exception {
        String respuesta;
        AccesoDatos accesoDatos;
        String sql;
        PreparedStatement prstm;
        ...
        try {
            accesoDatos = new AccesoDatos();
            sql = "select * from catastro.f_actualizar_coef_topografia(?,?,?,?,?)";
            prstm = accesoDatos.creaPreparedSmt(sql);
            prstm.setString(1, coeficiente.getCoeficiente());
            prstm.setInt(2, coeficiente.getCodigo());
            prstm.setDouble(3, coeficiente.getValorCoeficiente());
    ...
    public static String eliminarCoeficiente(CoefTopografia coeficiente) throws Exception {
        String respuesta;
        AccesoDatos accesoDatos;
        String sql;
        PreparedStatement prstm;
        ...
        try {
            accesoDatos = new AccesoDatos();
            sql = "select * from catastro.f_desactivar_coef_topografia(?)";
            prstm = accesoDatos.creaPreparedSmt(sql);
