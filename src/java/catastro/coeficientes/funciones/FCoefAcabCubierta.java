...
public class FCoefAcabCubierta {
    ...
    public static List<CoefAcabadosCubierta> obtenerCoefAcabadosCubierta() throws Exception {
        ...
        public static String registrarCoeficiente(CoefAcabadosCubierta coeficiente) throws Exception {
        String respuesta;
        AccesoDatos accesoDatos;
        String sql;
        ...
        try {
            accesoDatos = new AccesoDatos();
            sql = "select * from catastro.f_insertar_coef_acab_cubierta(?,?,?)";
    ...
    public static String actualizarCoeficiente(CoefAcabadosCubierta coeficiente) throws Exception {
        String respuesta;
        AccesoDatos accesoDatos;
        String sql;
        PreparedStatement prstm;
        ...
        try {
            accesoDatos = new AccesoDatos();
            sql = "select * from catastro.f_actualizar_coef_acab_cubierta(?,?,?,?)";
            prstm = accesoDatos.creaPreparedSmt(sql);
            prstm.setString(1, coeficiente.getCoeficiente());
            prstm.setInt(2, coeficiente.getCodigo());
            prstm.setDouble(3, coeficiente.getValorCoeficiente());
    ...
    public static String eliminarCoeficiente(CoefAcabadosCubierta coeficiente) throws Exception {
        String respuesta;
        AccesoDatos accesoDatos;
        String sql;
        PreparedStatement prstm;
        ...
        try {
            accesoDatos = new AccesoDatos();
            sql = "select * from catastro.f_desactivar_coef_acab_cubierta(?)";
            prstm = accesoDatos.creaPreparedSmt(sql);
