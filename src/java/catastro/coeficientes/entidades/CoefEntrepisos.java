 ...
 * @author Geovanny
 */
public class CoefEntrepisos {

    private int idCoefEntrepisos;
    ...
    /**
     * @return the idCoefEntrepisos
     */
    public int getIdCoefEntrepisos() {
        return idCoefEntrepisos;
    }

    /**
     * @param idCoefEntrepisos the idCoefEntrepisos to set
     */
    public void setIdCoefEntrepisos(int idCoefEntrepisos) {
        this.idCoefEntrepisos = idCoefEntrepisos;
    }
