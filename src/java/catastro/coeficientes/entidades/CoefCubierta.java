 ...
 * @author Geovanny
 */
public class CoefCubierta {

    private int idCoefCubierta;
    ...
    /**
     * @return the idCoefCubierta
     */
    public int getIdCoefCubierta() {
        return idCoefCubierta;
    }

    /**
     * @param idCoefCubierta the idCoefCubierta to set
     */
    public void setIdCoefCubierta(int idCoefCubierta) {
        this.idCoefCubierta = idCoefCubierta;
    }
