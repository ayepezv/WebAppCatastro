 ...
 * @author Geovanny
 */
public class CoefPuertas {

    private int idCoefPuertas;
    ...
    /**
     * @return the idCoefPuertas
     */
    public int getIdCoefPuertas() {
        return idCoefPuertas;
    }

    /**
     * @param idCoefPuertas the idCoefPuertas to set
     */
    public void setIdCoefPuertas(int idCoefPuertas) {
        this.idCoefPuertas = idCoefPuertas;
    }
