 ...
 * @author Geovanny
 */
public class CoefPisos {

    private int idCoefPisos;
    ...
    /**
     * @return the idCoefPisos
     */
    public int getIdCoefPisos() {
        return idCoefPisos;
    }

    /**
     * @param idCoefPisos the idCoefPisos to set
     */
    public void setIdCoefPisos(int idCoefPisos) {
        this.idCoefPisos = idCoefPisos;
    }
