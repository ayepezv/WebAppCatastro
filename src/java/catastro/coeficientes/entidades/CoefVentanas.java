 ...
 * @author Geovanny
 */
public class CoefVentanas {

    private int idCoefVentanas;
    ...
    /**
     * @return the idCoefVentanas
     */
    public int getIdCoefVentanas() {
        return idCoefVentanas;
    }

    /**
     * @param idCoefVentanas the idCoefVentanas to set
     */
    public void setIdCoefVentanas(int idCoefVentanas) {
        this.idCoefVentanas = idCoefVentanas;
    }
