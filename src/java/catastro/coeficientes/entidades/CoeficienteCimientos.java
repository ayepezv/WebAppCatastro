 ...
 * @author Geovanny
 */
public class CoeficienteCimientos {

    private int idCoefCimientos;
    ...
    public int getIdCoefCimientos() {
        return idCoefCimientos;
    }

    public void setIdCoefCimientos(int idCoefCimientos) {
        this.idCoefCimientos = idCoefCimientos;
    }
