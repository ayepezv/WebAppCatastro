 ...
 * @author Geovanny
 */
public class CoefVigas {

    private int idCoefVigas;
    ...
    /**
     * @return the idCoefVigas
     */
    public int getIdCoefVigas() {
        return idCoefVigas;
    }

    /**
     * @param idCoefVigas the idCoefVigas to set
     */
    public void setIdCoefVigas(int idCoefVigas) {
        this.idCoefVigas = idCoefVigas;
    }
