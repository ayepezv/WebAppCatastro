 ...
 * @author Geovanny
 */
public class CoefTumbados {

    private int idCoefTumbados;
    ...
    /**
     * @return the idCoefTumbados
     */
    public int getIdCoefTumbados() {
        return idCoefTumbados;
    }

    /**
     * @param idCoefTumbados the idCoefTumbados to set
     */
    public void setIdCoefTumbados(int idCoefTumbados) {
        this.idCoefTumbados = idCoefTumbados;
    }
