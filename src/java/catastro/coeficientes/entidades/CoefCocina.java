 ...
 * @author Geovanny
 */
public class CoefCocina {

    private int idCoefCocina;
    ...
    /**
     * @return the idCoefCocina
     */
    public int getIdCoefCocina() {
        return idCoefCocina;
    }

    /**
     * @param idCoefCocina the idCoefCocina to set
     */
    public void setIdCoefCocina(int idCoefCocina) {
        this.idCoefCocina = idCoefCocina;
    }
