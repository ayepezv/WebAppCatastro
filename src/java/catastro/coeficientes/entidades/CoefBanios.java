 ...
 * @author Geovanny
 */
public class CoefBanios {

    private int idCoefBanios;
    ...
    /**
     * @return the idCoefBanios
     */
    public int getIdCoefBanios() {
        return idCoefBanios;
    }

    /**
     * @param idCoefBanios the idCoefBanios to set
     */
    public void setIdCoefBanios(int idCoefBanios) {
        this.idCoefBanios = idCoefBanios;
    }
