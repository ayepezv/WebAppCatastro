 ...
 * @author Geovanny
 */
public class CoefColumnas {

    private int idCoefColumnas;
    ...
    /**
     * @return the idCoefColumnas
     */
    public int getIdCoefColumnas() {
        return idCoefColumnas;
    }

    /**
     * @param idCoefColumnas the idCoefColumnas to set
     */
    public void setIdCoefColumnas(int idCoefColumnas) {
        this.idCoefColumnas = idCoefColumnas;
    }
