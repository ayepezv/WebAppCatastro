 ...
 * @author Geovanny
 */
public class CoefClosets {

    private int idCoefClosets;
    ...
    /**
     * @return the idCoefClosets
     */
    public int getIdCoefClosets() {
        return idCoefClosets;
    }

    /**
     * @param idCoefClosets the idCoefClosets to set
     */
    public void setIdCoefClosets(int idCoefClosets) {
        this.idCoefClosets = idCoefClosets;
    }
